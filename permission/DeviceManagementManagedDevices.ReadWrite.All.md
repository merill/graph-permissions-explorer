...
|Beta|A,D|[DELETE /deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScriptId}/userRunStates/{deviceManagementScriptUserStateId}](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptuserstate-delete?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[DELETE /deviceManagement/managedDeviceCleanupRules/{managedDeviceCleanupRuleId}](https://docs.microsoft.com/graph/api/intune-devices-manageddevicecleanuprule-delete?view=graph-rest-beta&tabs=http)|
...
|V1|A,D|[PATCH /deviceManagement/detectedApps/{detectedAppId}](https://docs.microsoft.com/graph/api/intune-devices-detectedapp-update?view=graph-rest-1.0&tabs=http)|
...
|V1|A,D|[PATCH /deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEventId}](https://docs.microsoft.com/graph/api/intune-devices-mobileapptroubleshootingevent-update?view=graph-rest-1.0&tabs=http)|
...
|V1|A,D|[POST /deviceManagement/detectedApps/{detectedAppId}/managedDevices](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-create?view=graph-rest-1.0&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScriptId}/deviceRunStates](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptdevicestate-create?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/logCollectionRequests](https://docs.microsoft.com/graph/api/intune-devices-devicelogcollectionresponse-create?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/requestRemoteAssistance](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-requestremoteassistance?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/rotateBitLockerKeys](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-rotatebitlockerkeys?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/sendCustomNotificationToCompanyPortal](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-sendcustomnotificationtocompanyportal?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/users](https://docs.microsoft.com/graph/api/intune-devices-user-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/users/{userId}/managedDevices](https://docs.microsoft.com/graph/api/intune-devices-windowsmanageddevice-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/users/{userId}/managedDevices/{managedDeviceId}/createDeviceLogCollectionRequest](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-createdevicelogcollectionrequest?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/users/{userId}/managedDevices/{managedDeviceId}/requestRemoteAssistance](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-requestremoteassistance?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/users/{userId}/managedDevices/{managedDeviceId}/rotateBitLockerKeys](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-rotatebitlockerkeys?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/users/{userId}/managedDevices/{managedDeviceId}/sendCustomNotificationToCompanyPortal](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-sendcustomnotificationtocompanyportal?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/deviceRunStates/{deviceManagementScriptDeviceStateId}/managedDevice/windowsProtectionState/detectedMalwareState](https://docs.microsoft.com/graph/api/intune-devices-windowsdevicemalwarestate-create?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/groupAssignments](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptgroupassignment-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/userRunStates](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptuserstate-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceManagementScripts/{deviceManagementScriptId}/userRunStates/{deviceManagementScriptUserStateId}/deviceRunStates](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptdevicestate-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceShellScripts](https://docs.microsoft.com/graph/api/intune-devices-deviceshellscript-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceShellScripts/{deviceShellScriptId}/assign](https://docs.microsoft.com/graph/api/intune-devices-deviceshellscript-assign?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceShellScripts/{deviceShellScriptId}/assignments](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptassignment-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceShellScripts/{deviceShellScriptId}/deviceRunStates](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptdevicestate-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceShellScripts/{deviceShellScriptId}/groupAssignments](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptgroupassignment-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/deviceShellScripts/{deviceShellScriptId}/userRunStates](https://docs.microsoft.com/graph/api/intune-devices-devicemanagementscriptuserstate-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/managedDeviceCleanupRules](https://docs.microsoft.com/graph/api/intune-devices-manageddevicecleanuprule-create?view=graph-rest-beta&tabs=http)|
|V1|A,D|[POST /deviceManagement/managedDevices](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-create?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /deviceManagement/managedDevices/{managedDeviceId}/createDeviceLogCollectionRequest](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-createdevicelogcollectionrequest?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /deviceManagement/managedDevices/{managedDeviceId}/requestRemoteAssistance](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-requestremoteassistance?view=graph-rest-1.0&tabs=http)|
|Beta|A,D|[POST /deviceManagement/managedDevices/{managedDeviceId}/rotateBitLockerKeys](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-rotatebitlockerkeys?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/managedDevices/{managedDeviceId}/sendCustomNotificationToCompanyPortal](https://docs.microsoft.com/graph/api/intune-devices-manageddevice-sendcustomnotificationtocompanyportal?view=graph-rest-beta&tabs=http)|
...
|V1|A,D|[POST /deviceManagement/mobileAppTroubleshootingEvents](https://docs.microsoft.com/graph/api/intune-devices-mobileapptroubleshootingevent-create?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEventId}/appLogCollectionRequests](https://docs.microsoft.com/graph/api/intune-devices-applogcollectionrequest-create?view=graph-rest-1.0&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/remoteActionAudits](https://docs.microsoft.com/graph/api/intune-devices-remoteactionaudit-create?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/sendCustomNotificationToCompanyPortal](https://docs.microsoft.com/graph/api/intune-devices-devicemanagement-sendcustomnotificationtocompanyportal?view=graph-rest-beta&tabs=http)|
|V1|A,D|[POST /deviceManagement/troubleshootingEvents](https://docs.microsoft.com/graph/api/intune-troubleshooting-enrollmenttroubleshootingevent-create?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /deviceManagement/windowsMalwareInformation](https://docs.microsoft.com/graph/api/intune-devices-windowsmalwareinformation-create?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /deviceManagement/windowsMalwareInformation/{windowsMalwareInformationId}/deviceMalwareStates](https://docs.microsoft.com/graph/api/intune-devices-malwarestateforwindowsdevice-create?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /users](https://docs.microsoft.com/graph/api/intune-troubleshooting-user-create?view=graph-rest-1.0&tabs=http)|
|Beta|A,D|[POST /users/{usersId}/mobileAppIntentAndStates](https://docs.microsoft.com/graph/api/intune-troubleshooting-mobileappintentandstate-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /users/{usersId}/mobileAppTroubleshootingEvents](https://docs.microsoft.com/graph/api/intune-troubleshooting-mobileapptroubleshootingevent-create?view=graph-rest-beta&tabs=http)|
## Delegate Permission
|||
|-|-|
...
## Resources
### [intune-devices-actioncategory](https://docs.microsoft.com/graph/api/resources/intune-devices-actioncategory?view=graph-rest-1.0&tabs=http)

### [adminConsent ](https://docs.microsoft.com/graph/api/resources/intune-devices-adminconsent?view=graph-rest-1.0&tabs=http)
...
### [intune-devices-apploguploadstate](https://docs.microsoft.com/graph/api/resources/intune-devices-apploguploadstate?view=graph-rest-1.0&tabs=http)

### [intune-devices-chassistype](https://docs.microsoft.com/graph/api/resources/intune-devices-chassistype?view=graph-rest-1.0&tabs=http)

### [chromeOSDeviceProperty ](https://docs.microsoft.com/graph/api/resources/intune-devices-chromeosdeviceproperty?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-devices-comanagementeligibletype](https://docs.microsoft.com/graph/api/resources/intune-devices-comanagementeligibletype?view=graph-rest-1.0&tabs=http)

### [intune-devices-compliancestate](https://docs.microsoft.com/graph/api/resources/intune-devices-compliancestate?view=graph-rest-1.0&tabs=http)

### [configurationManagerClientEnabledFeatures ](https://docs.microsoft.com/graph/api/resources/intune-devices-configurationmanagerclientenabledfeatures?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [configurationManagerClientHealthState ](https://docs.microsoft.com/graph/api/resources/intune-devices-configurationmanagerclienthealthstate?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [configurationManagerClientInformation ](https://docs.microsoft.com/graph/api/resources/intune-devices-configurationmanagerclientinformation?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [dataProcessorServiceForWindowsFeaturesOnboarding ](https://docs.microsoft.com/graph/api/resources/intune-devices-dataprocessorserviceforwindowsfeaturesonboarding?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-devices-detectedappplatformtype](https://docs.microsoft.com/graph/api/resources/intune-devices-detectedappplatformtype?view=graph-rest-1.0&tabs=http)

### [deviceActionResult ](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceactionresult?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-devices-devicecleanupruleplatformtype](https://docs.microsoft.com/graph/api/resources/intune-devices-devicecleanupruleplatformtype?view=graph-rest-1.0&tabs=http)
...
### [intune-devices-devicecustomattributevaluetype](https://docs.microsoft.com/graph/api/resources/intune-devices-devicecustomattributevaluetype?view=graph-rest-1.0&tabs=http)

### [intune-devices-deviceenrollmenttype](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceenrollmenttype?view=graph-rest-1.0&tabs=http)

### [deviceExchangeAccessStateSummary ](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceexchangeaccessstatesummary?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [deviceHealthAttestationState ](https://docs.microsoft.com/graph/api/resources/intune-devices-devicehealthattestationstate?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [deviceHealthScriptAssignment ](https://docs.microsoft.com/graph/api/resources/intune-devices-devicehealthscriptassignment?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [deviceIdentityAttestationDetail ](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceidentityattestationdetail?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|deviceIdentityAttestationStatus|deviceIdentityAttestationStatus|Indicates the attestation status of the managed device. And in which way. Default: Unknown. This property is read-only. Possible values are: `unknown`, `trusted`, `unTrusted`, `notSupported`, `incompleteData`, `unknownFutureValue`.|
...
### [deviceInventoryValue ](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceinventoryvalue?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
### [deviceLogCollectionRequest ](https://docs.microsoft.com/graph/api/resources/intune-devices-devicelogcollectionrequest?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|id|String|The unique identifier|
|templateType|deviceLogCollectionTemplateType|Indicates The template type that is sent with the collection request. defaule is Predefined. Possible values are: `predefined`, `unknownFutureValue`.|
...
### [intune-devices-devicemanagementexchangeaccessstate](https://docs.microsoft.com/graph/api/resources/intune-devices-devicemanagementexchangeaccessstate?view=graph-rest-1.0&tabs=http)

### [intune-devices-devicemanagementexchangeaccessstatereason](https://docs.microsoft.com/graph/api/resources/intune-devices-devicemanagementexchangeaccessstatereason?view=graph-rest-1.0&tabs=http)
...
### [intune-devices-devicemanagementsubscriptions](https://docs.microsoft.com/graph/api/resources/intune-devices-devicemanagementsubscriptions?view=graph-rest-1.0&tabs=http)

### [intune-devices-devicemanagementsubscriptionstate](https://docs.microsoft.com/graph/api/resources/intune-devices-devicemanagementsubscriptionstate?view=graph-rest-1.0&tabs=http)

### [deviceOperatingSystemSummary ](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceoperatingsystemsummary?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [deviceProtectionOverview ](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceprotectionoverview?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-devices-deviceregistrationstate](https://docs.microsoft.com/graph/api/resources/intune-devices-deviceregistrationstate?view=graph-rest-1.0&tabs=http)
...
|fileName|String|Script file name.|
|roleScopeTagIds|String collection|List of Scope Tag IDs for this PowerShellScript instance.|
### [hardwareInformation ](https://docs.microsoft.com/graph/api/resources/intune-devices-hardwareinformation?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-devices-healthstate](https://docs.microsoft.com/graph/api/resources/intune-devices-healthstate?view=graph-rest-1.0&tabs=http)

### [intune-devices-jointype](https://docs.microsoft.com/graph/api/resources/intune-devices-jointype?view=graph-rest-1.0&tabs=http)

### [loggedOnUser ](https://docs.microsoft.com/graph/api/resources/intune-devices-loggedonuser?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|userId|String|User id|
|lastLogOnDateTime|DateTimeOffset|Date time when user logs on|
### [intune-devices-lostmodestate](https://docs.microsoft.com/graph/api/resources/intune-devices-lostmodestate?view=graph-rest-1.0&tabs=http)
...
### [managedDeviceCleanupSettings ](https://docs.microsoft.com/graph/api/resources/intune-devices-manageddevicecleanupsettings?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|deviceInactivityBeforeRetirementInDays|String|Number of days when the device has not contacted Intune.|
### [intune-devices-manageddevicemanagementfeatures](https://docs.microsoft.com/graph/api/resources/intune-devices-manageddevicemanagementfeatures?view=graph-rest-1.0&tabs=http)

### [managedDeviceModelsAndManufacturers ](https://docs.microsoft.com/graph/api/resources/intune-devices-manageddevicemodelsandmanufacturers?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-devices-manageddeviceownertype](https://docs.microsoft.com/graph/api/resources/intune-devices-manageddeviceownertype?view=graph-rest-1.0&tabs=http)

### [intune-devices-manageddevicepartnerreportedhealthstate](https://docs.microsoft.com/graph/api/resources/intune-devices-manageddevicepartnerreportedhealthstate?view=graph-rest-1.0&tabs=http)

### [intune-devices-managedinstallerstatus](https://docs.microsoft.com/graph/api/resources/intune-devices-managedinstallerstatus?view=graph-rest-1.0&tabs=http)

### [intune-devices-managementagenttype](https://docs.microsoft.com/graph/api/resources/intune-devices-managementagenttype?view=graph-rest-1.0&tabs=http)

### [intune-devices-managementstate](https://docs.microsoft.com/graph/api/resources/intune-devices-managementstate?view=graph-rest-1.0&tabs=http)
...
### [intune-devices-remoteaction](https://docs.microsoft.com/graph/api/resources/intune-devices-remoteaction?view=graph-rest-1.0&tabs=http)
...
### [userExperienceAnalyticsAnomalySeverityOverview ](https://docs.microsoft.com/graph/api/resources/intune-devices-userexperienceanalyticsanomalyseverityoverview?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [userExperienceAnalyticsSettings ](https://docs.microsoft.com/graph/api/resources/intune-devices-userexperienceanalyticssettings?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [userExperienceAnalyticsWorkFromAnywhereDevicesSummary ](https://docs.microsoft.com/graph/api/resources/intune-devices-userexperienceanalyticsworkfromanywheredevicessummary?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|autopilotDevicesSummary|userExperienceAnalyticsAutopilotDevicesSummary|The user experience analytics work from anywhere Autopilot devices summary. Read-only.|
|cloudManagementDevicesSummary|userExperienceAnalyticsCloudManagementDevicesSummary|The user experience analytics work from anywhere Cloud management devices summary. Read-only.|
|windows10DevicesSummary|userExperienceAnalyticsWindows10DevicesSummary|The user experience analytics work from anywhere Windows 10 devices summary. Read-only.|
|cloudIdentityDevicesSummary|userExperienceAnalyticsCloudIdentityDevicesSummary|The user experience analytics work from anywhere Cloud Identity devices summary. Read-only.|
...
### [intune-devices-windowsdefenderproductstatus](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsdefenderproductstatus?view=graph-rest-1.0&tabs=http)

### [intune-devices-windowsdevicehealthstate](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsdevicehealthstate?view=graph-rest-1.0&tabs=http)
...
### [intune-devices-windowsmalwarecategory](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsmalwarecategory?view=graph-rest-1.0&tabs=http)

### [intune-devices-windowsmalwareexecutionstate](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsmalwareexecutionstate?view=graph-rest-1.0&tabs=http)
...
### [windowsMalwareOverview ](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsmalwareoverview?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-devices-windowsmalwareseverity](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsmalwareseverity?view=graph-rest-1.0&tabs=http)

### [intune-devices-windowsmalwarestate](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsmalwarestate?view=graph-rest-1.0&tabs=http)

### [intune-devices-windowsmalwarethreatstate](https://docs.microsoft.com/graph/api/resources/intune-devices-windowsmalwarethreatstate?view=graph-rest-1.0&tabs=http)
...
|displayName|String|Display name for the device category.|
|description|String|Optional description for the device category.|
### [intune-shared-deviceenrollmenttype](https://docs.microsoft.com/graph/api/resources/intune-shared-deviceenrollmenttype?view=graph-rest-1.0&tabs=http)
...
### [intune-shared-devicetype](https://docs.microsoft.com/graph/api/resources/intune-shared-devicetype?view=graph-rest-1.0&tabs=http)
...
### [intune-shared-manageddevicearchitecture](https://docs.microsoft.com/graph/api/resources/intune-shared-manageddevicearchitecture?view=graph-rest-1.0&tabs=http)

### [intune-shared-manageddeviceownertype](https://docs.microsoft.com/graph/api/resources/intune-shared-manageddeviceownertype?view=graph-rest-1.0&tabs=http)

### [intune-shared-managementagenttype](https://docs.microsoft.com/graph/api/resources/intune-shared-managementagenttype?view=graph-rest-1.0&tabs=http)
...
### [intune-shared-ownertype](https://docs.microsoft.com/graph/api/resources/intune-shared-ownertype?view=graph-rest-1.0&tabs=http)
...
### [intune-shared-runasaccounttype](https://docs.microsoft.com/graph/api/resources/intune-shared-runasaccounttype?view=graph-rest-1.0&tabs=http)

### [intune-shared-runstate](https://docs.microsoft.com/graph/api/resources/intune-shared-runstate?view=graph-rest-1.0&tabs=http)
...
### [connectorStatusDetails ](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-connectorstatusdetails?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|connectorName|connectorName|Connector name. Possible values are: `applePushNotificationServiceExpirationDateTime`, `vppTokenExpirationDateTime`, `vppTokenLastSyncDateTime`, `windowsAutopilotLastSyncDateTime`, `windowsStoreForBusinessLastSyncDateTime`, `jamfLastSyncDateTime`, `ndesConnectorLastConnectionDateTime`, `appleDepExpirationDateTime`, `appleDepLastSyncDateTime`, `onPremConnectorLastSyncDateTime`, `googlePlayAppLastSyncDateTime`, `googlePlayConnectorLastModifiedDateTime`, `windowsDefenderATPConnectorLastHeartbeatDateTime`, `mobileThreatDefenceConnectorLastHeartbeatDateTime`, `chromebookLastDirectorySyncDateTime`, `futureValue`.|
|connectorInstanceId|String|Connector Instance Id|
|status|connectorHealthState|Connector health state. Possible values are: `healthy`, `warning`, `unhealthy`, `unknown`.|
|eventDateTime|DateTimeOffset|Event datetime|
### [intune-troubleshooting-deviceenrollmentfailurereason](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-deviceenrollmentfailurereason?view=graph-rest-1.0&tabs=http)

### [intune-troubleshooting-deviceenrollmenttype](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-deviceenrollmenttype?view=graph-rest-1.0&tabs=http)
...
### [intune-troubleshooting-devicemanagementautopilotpolicycompliancestatus](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-devicemanagementautopilotpolicycompliancestatus?view=graph-rest-1.0&tabs=http)
...
### [intune-troubleshooting-devicemanagementautopilotpolicytype](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-devicemanagementautopilotpolicytype?view=graph-rest-1.0&tabs=http)

### [deviceManagementTroubleshootingErrorDetails ](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-devicemanagementtroubleshootingerrordetails?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|context|String||
|failure|String||
...
### [mobileAppIntentAndStateDetail ](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-mobileappintentandstatedetail?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [mobileAppTroubleshootingHistoryItem ](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-mobileapptroubleshootinghistoryitem?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [report ](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-report?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-troubleshooting-windowsautopilotdeploymentstate](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-windowsautopilotdeploymentstate?view=graph-rest-1.0&tabs=http)

### [intune-troubleshooting-windowsautopilotenrollmenttype](https://docs.microsoft.com/graph/api/resources/intune-troubleshooting-windowsautopilotenrollmenttype?view=graph-rest-1.0&tabs=http)
