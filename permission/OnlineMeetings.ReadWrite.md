...
|Ver|Type|Method|
|-------|----|------|
|Beta|D|[DELETE /me/onlineMeetings/{id}/registration](https://docs.microsoft.com/graph/api/meetingregistration-delete?view=graph-rest-beta&tabs=http)|
|V1|D|[DELETE /me/onlineMeetings/{meetingId}](https://docs.microsoft.com/graph/api/onlinemeeting-delete?view=graph-rest-1.0&tabs=http)|
|Beta|D|[DELETE /me/onlineMeetings/{meetingId}/registration](https://docs.microsoft.com/graph/api/externalmeetingregistration-delete?view=graph-rest-beta&tabs=http)|
|Beta|D|[DELETE /me/onlineMeetings/{meetingId}/registration/customQuestions/{id}](https://docs.microsoft.com/graph/api/meetingregistrationquestion-delete?view=graph-rest-beta&tabs=http)|
|Beta|D|[DELETE /me/onlineMeetings/{meetingId}/registration/registrants/{registrantId}](https://docs.microsoft.com/graph/api/externalmeetingregistrant-delete?view=graph-rest-beta&tabs=http)|
|Beta|D|[DELETE /me/onlineMeetings/{onlineMeetingId}/virtualAppointment](https://docs.microsoft.com/graph/api/virtualappointment-delete?view=graph-rest-beta&tabs=http)|
|V1|D|[DELETE /users/{userId}/onlineMeetings/{meetingId}](https://docs.microsoft.com/graph/api/onlinemeeting-delete?view=graph-rest-1.0&tabs=http)|
|Beta|D|[DELETE /users/{userId}/onlineMeetings/{meetingId}/registration](https://docs.microsoft.com/graph/api/externalmeetingregistration-delete?view=graph-rest-beta&tabs=http)|
|Beta|D|[DELETE /users/{userId}/onlineMeetings/{meetingId}/registration/registrants/{id}](https://docs.microsoft.com/graph/api/meetingregistrant-delete?view=graph-rest-beta&tabs=http)|
|Beta|D|[DELETE /users/{userId}/onlineMeetings/{meetingId}/registration/registrants/{registrantId}](https://docs.microsoft.com/graph/api/externalmeetingregistrant-delete?view=graph-rest-beta&tabs=http)|
|Beta|D|[DELETE /users/{userId}/onlineMeetings/{onlineMeetingId}/virtualAppointment](https://docs.microsoft.com/graph/api/virtualappointment-delete?view=graph-rest-beta&tabs=http)|
...
|Beta|D|[PATCH /me/onlineMeetings/{id}/registration](https://docs.microsoft.com/graph/api/meetingregistration-update?view=graph-rest-beta&tabs=http)|
|V1|D|[PATCH /me/onlineMeetings/{meetingId}](https://docs.microsoft.com/graph/api/onlinemeeting-update?view=graph-rest-1.0&tabs=http)|
|Beta|D|[PATCH /me/onlineMeetings/{meetingId}/registration/customQuestions/{id}](https://docs.microsoft.com/graph/api/meetingregistrationquestion-update?view=graph-rest-beta&tabs=http)|
|Beta|D|[PATCH /me/onlineMeetings/{onlineMeetingId}/virtualAppointment](https://docs.microsoft.com/graph/api/virtualappointment-update?view=graph-rest-beta&tabs=http)|
|V1|D|[PATCH /users/{userId}/onlineMeetings/{meetingId}](https://docs.microsoft.com/graph/api/onlinemeeting-update?view=graph-rest-1.0&tabs=http)|
