...
|V1|A|[GET /users/{user-id | user-principal-name}/teamwork/installedApps/{app-installation-id}/chat](https://docs.microsoft.com/graph/api/userscopeteamsappinstallation-get-chat?view=graph-rest-1.0&tabs=http)|
## Application Permission
|||
|-|-|
|**Id**|0fdf35a5-82f8-41ff-9ded-0b761cc73512|
|**Display String**|Read installed Teams apps for all installation scopes|
