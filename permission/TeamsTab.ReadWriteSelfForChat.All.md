...
|Ver|Type|Method|
|-------|----|------|
|V1|A|[DELETE /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-delete-tabs?view=graph-rest-1.0&tabs=http)|
|V1|A|[GET /chats/{chat-id}/tabs](https://docs.microsoft.com/graph/api/chat-list-tabs?view=graph-rest-1.0&tabs=http)|
|V1|A|[GET /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-get-tabs?view=graph-rest-1.0&tabs=http)|
|V1|A|[PATCH /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-patch-tabs?view=graph-rest-1.0&tabs=http)|
|V1|A|[POST /chats/{chat-id}/tabs](https://docs.microsoft.com/graph/api/chat-post-tabs?view=graph-rest-1.0&tabs=http)|
## Application Permission
|||
|-|-|
|**Id**|9f62e4a2-a2d6-4350-b28b-d244728c4f86|
|**Display String**|Allow the Teams app to manage only its own tabs for all chats|
