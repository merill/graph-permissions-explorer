...
|Ver|Type|Method|
|-------|----|------|
|V1|A,D|[DELETE /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-delete-tabs?view=graph-rest-1.0&tabs=http)|
...
|V1|A,D|[PATCH /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-patch-tabs?view=graph-rest-1.0&tabs=http)|
...
|**Consent Type**|Admin|
|**Display String**|Allow the Teams app to manage all tabs in chats|
