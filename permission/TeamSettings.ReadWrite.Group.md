...
|V1|A|[PATCH /teams/{team-id}](https://docs.microsoft.com/graph/api/team-update?view=graph-rest-1.0&tabs=http)|
|V1|A|[POST /teams/{id}/archive](https://docs.microsoft.com/graph/api/team-archive?view=graph-rest-1.0&tabs=http)|
|V1|A|[POST /teams/{id}/unarchive](https://docs.microsoft.com/graph/api/team-unarchive?view=graph-rest-1.0&tabs=http)|
