...
|Ver|Type|Method|
|-------|----|------|
|V1|A,D|[DELETE /teams/{team-id}/members/{membership-id}](https://docs.microsoft.com/graph/api/team-delete-members?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[GET /teams/{team-id}/members](https://docs.microsoft.com/graph/api/team-list-members?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[GET /teams/{team-id}/members/{membership-id}](https://docs.microsoft.com/graph/api/team-get-members?view=graph-rest-1.0&tabs=http)|
...
|V1|A,D|[POST /teams/{team-id}/members](https://docs.microsoft.com/graph/api/team-post-members?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /teams/{team-id}/members/add](https://docs.microsoft.com/graph/api/conversationmembers-add?view=graph-rest-1.0&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|4a06efd2-f825-4e34-813e-82a57b03d1ee|
|**Consent Type**|Admin|
|**Display String**|Add and remove members from teams|
...
|**Display String**|Add and remove members from all teams|
...
## Resources
### [aadUserConversationMember ](https://docs.microsoft.com/graph/api/resources/aaduserconversationmember?view=graph-rest-1.0&tabs=http)
...
### [actionResultPart ](https://docs.microsoft.com/graph/api/resources/actionresultpart?view=graph-rest-1.0&tabs=http)
| Property | Type	| Description |
|:---------------|:--------|:----------|
