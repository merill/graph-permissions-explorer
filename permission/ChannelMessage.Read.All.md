...
|V1|A,D|[GET /teams/{team-id}/channels/{channel-id}/messages/{message-id}/hostedContents](https://docs.microsoft.com/graph/api/chatmessage-list-hostedcontents?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[GET /teams/{team-id}/channels/{channel-id}/messages/{message-id}/hostedContents/{hosted-content-id}](https://docs.microsoft.com/graph/api/chatmessagehostedcontent-get?view=graph-rest-1.0&tabs=http)|
...
|V1|A,D|[GET /teams/{team-id}/channels/{channel-id}/messages/{message-id}/replies/{reply-id}/hostedContents](https://docs.microsoft.com/graph/api/chatmessage-list-hostedcontents?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[GET /teams/{team-id}/channels/{channel-id}/messages/{message-id}/replies/{reply-id}/hostedContents/{hosted-content-id}](https://docs.microsoft.com/graph/api/chatmessagehostedcontent-get?view=graph-rest-1.0&tabs=http)|
...
|V1|A|[GET /teams/{team-id}/channels/getAllMessages](https://docs.microsoft.com/graph/api/channel-getallmessages?view=graph-rest-1.0&tabs=http)|
|Beta|A|[GET /teams/{teamsId}/channels/getAllRetainedMessages](https://docs.microsoft.com/graph/api/channel-getallretainedmessages?view=graph-rest-beta&tabs=http)|
|V1|A|[GET /teamwork/deletedTeams/{deletedTeamId}/channels/getAllMessages](https://docs.microsoft.com/graph/api/deletedteam-getallmessages?view=graph-rest-1.0&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|767156cb-16ae-4d10-8f8b-41b657c8c8c8|
|**Consent Type**|Admin|
|**Display String**|Read user channel messages|
...
### [deletedTeam ](https://docs.microsoft.com/graph/api/resources/deletedteam?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
