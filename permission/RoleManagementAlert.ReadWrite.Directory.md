...
|Beta|A,D|[PATCH /identityGovernance/roleManagementAlerts/alertConfigurations/{unifiedRoleManagementAlertConfigurationId}](https://docs.microsoft.com/graph/api/unifiedrolemanagementalertconfiguration-update?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[PATCH /identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlertId}](https://docs.microsoft.com/graph/api/unifiedrolemanagementalert-update?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlertId}/alertIncidents/{unifiedRoleManagementAlertIncidentId}/remediate](https://docs.microsoft.com/graph/api/unifiedrolemanagementalertincident-remediate?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /identityGovernance/roleManagementAlerts/alerts/refresh](https://docs.microsoft.com/graph/api/unifiedrolemanagementalert-refresh?view=graph-rest-beta&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|435644c6-a5b1-40bf-8f52-fe8e5b53e19c|
|**Consent Type**|Admin|
|**Display String**|Read all alert data, configure alerts, and take actions on all alerts for your company's directory|
|**Description**|Allows the app to read and manage the role-based access control (RBAC) alerts for your company's directory, on behalf of the signed-in user. This includes managing alert settings, initiating alert scans, dimissing alerts, remediating alert incidents, and reading alert statuses, alert definitions, alert configurations and incidents that lead to an alert.|
