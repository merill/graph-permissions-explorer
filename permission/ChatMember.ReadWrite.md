...
|Ver|Type|Method|
|-------|----|------|
|V1|D|[DELETE /chats/{chat-id}/members/{membership-id}](https://docs.microsoft.com/graph/api/chat-delete-members?view=graph-rest-1.0&tabs=http)|
...
|**Consent Type**|Admin|
|**Display String**|Add and remove members from chats|
