...
|Ver|Type|Method|
|-------|----|------|
|V1|D|[DELETE /me/authentication/emailMethods/{emailMethods-id}](https://docs.microsoft.com/graph/api/emailauthenticationmethod-delete?view=graph-rest-1.0&tabs=http)|
|V1|D|[DELETE /me/authentication/fido2Methods/{id}](https://docs.microsoft.com/graph/api/fido2authenticationmethod-delete?view=graph-rest-1.0&tabs=http)|
|V1|D|[DELETE /me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethodId}](https://docs.microsoft.com/graph/api/microsoftauthenticatorauthenticationmethod-delete?view=graph-rest-1.0&tabs=http)|
|Beta|D|[DELETE /me/authentication/passwordlessMicrosoftAuthenticatorMethods/{id}](https://docs.microsoft.com/graph/api/passwordlessmicrosoftauthenticatorauthenticationmethod-delete?view=graph-rest-beta&tabs=http)|
|V1|D|[DELETE /me/authentication/phoneMethods/{phoneMethodId}](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-delete?view=graph-rest-1.0&tabs=http)|
|Beta|D|[DELETE /me/authentication/platformCredentialMethods/{platformCredentialAuthenticationMethodId}](https://docs.microsoft.com/graph/api/platformcredentialauthenticationmethod-delete?view=graph-rest-beta&tabs=http)|
|V1|D|[DELETE /me/authentication/softwareOathMethods/{id}](https://docs.microsoft.com/graph/api/softwareoathauthenticationmethod-delete?view=graph-rest-1.0&tabs=http)|
|V1|D|[DELETE /me/authentication/temporaryAccessPassMethods/{id}](https://docs.microsoft.com/graph/api/temporaryaccesspassauthenticationmethod-delete?view=graph-rest-1.0&tabs=http)|
|V1|D|[DELETE /me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethodId}](https://docs.microsoft.com/graph/api/windowshelloforbusinessauthenticationmethod-delete?view=graph-rest-1.0&tabs=http)|
...
|V1|D|[PATCH /users/{id | userPrincipalName}/authentication/emailMethods/{emailMethods-id}](https://docs.microsoft.com/graph/api/emailauthenticationmethod-update?view=graph-rest-1.0&tabs=http)|
|V1|D|[PATCH /users/{id | userPrincipalName}/authentication/phoneMethods/{phoneMethodId}](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-update?view=graph-rest-1.0&tabs=http)|
...
|Beta|D|[POST /me/authentication/phoneMethods/{id}/disableSmsSignIn](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-disablesmssignin?view=graph-rest-beta&tabs=http)|
|Beta|D|[POST /me/authentication/phoneMethods/{id}/enableSmsSignIn](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-enablesmssignin?view=graph-rest-beta&tabs=http)|
|V1|D|[POST /me/authentication/phoneMethods/{mobilePhoneMethodId}/disableSmsSignIn](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-disablesmssignin?view=graph-rest-1.0&tabs=http)|
|V1|D|[POST /me/authentication/phoneMethods/{mobilePhoneMethodId}/enableSmsSignIn](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-enablesmssignin?view=graph-rest-1.0&tabs=http)|
|V1|D|[POST /users/{id | userPrincipalName}/authentication/emailMethods](https://docs.microsoft.com/graph/api/authentication-post-emailmethods?view=graph-rest-1.0&tabs=http)|
|V1|D|[POST /users/{id | userPrincipalName}/authentication/phoneMethods](https://docs.microsoft.com/graph/api/authentication-post-phonemethods?view=graph-rest-1.0&tabs=http)|
|Beta|D|[POST /users/{id | userPrincipalName}/authentication/phoneMethods/{id}/disableSmsSignIn](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-disablesmssignin?view=graph-rest-beta&tabs=http)|
|Beta|D|[POST /users/{id | userPrincipalName}/authentication/phoneMethods/{id}/enableSmsSignIn](https://docs.microsoft.com/graph/api/phoneauthenticationmethod-enablesmssignin?view=graph-rest-beta&tabs=http)|
|Beta|D|[POST /users/{id}/authentication/fido2methods ](https://docs.microsoft.com/graph/api/authentication-post-fido2methods?view=graph-rest-beta&tabs=http)|
## Delegate Permission
|||
|-|-|
