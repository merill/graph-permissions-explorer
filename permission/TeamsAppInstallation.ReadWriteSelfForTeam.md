...
|V1|D|[POST /teams/{team-id}/installedApps](https://docs.microsoft.com/graph/api/team-post-installedapps?view=graph-rest-1.0&tabs=http)|
...
|**Consent Type**|Admin|
|**Display String**|Allow the app to manage itself in teams|
