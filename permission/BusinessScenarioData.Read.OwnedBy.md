...
|**Consent Type**|Admin|
|**Display String**|Read all data for business scenarios this app creates or owns|
...
|**Display String**|Read data for all business scenarios this app creates or owns|
