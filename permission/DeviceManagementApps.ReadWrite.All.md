...
|V1|A,D|[DELETE /deviceAppManagement/managedEBooks/{managedEBookId}/assignments/{managedEBookAssignmentId}](https://docs.microsoft.com/graph/api/intune-books-iosvppebookassignment-delete?view=graph-rest-1.0&tabs=http)|
...
|Beta|A,D|[DELETE /deviceAppManagement/mobileApps/{mobileAppId}/microsoft.graph.microsoftStoreForBusinessApp/containedApps/{mobileContainedAppId}](https://docs.microsoft.com/graph/api/intune-apps-windowsuniversalappxcontainedapp-delete?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[DELETE /deviceAppManagement/windowsManagedAppProtections/{windowsManagedAppProtectionId}](https://docs.microsoft.com/graph/api/intune-mam-windowsmanagedappprotection-delete?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[PATCH ** Entity URI for microsoft.management.services.api.appVulnerabilityMobileApp not found](https://docs.microsoft.com/graph/api/intune-partnerintegration-appvulnerabilitymobileapp-update?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[PATCH /deviceAppManagement/managedEBookCategories/{managedEBookCategoryId}](https://docs.microsoft.com/graph/api/intune-books-managedebookcategory-update?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[PATCH /deviceAppManagement/mobileApps/{mobileAppId}/deviceStatuses/{mobileAppInstallStatusId}](https://docs.microsoft.com/graph/api/intune-apps-mobileappinstallstatus-update?view=graph-rest-beta&tabs=http)|
...
|Beta|A,D|[POST ** Collection URI for microsoft.management.services.api.vulnerableManagedDevice not found](https://docs.microsoft.com/graph/api/intune-partnerintegration-vulnerablemanageddevice-create?view=graph-rest-beta&tabs=http)|
...
|V1|A,D|[POST /deviceAppManagement/managedAppRegistrations/{managedAppRegistrationId}/operations](https://docs.microsoft.com/graph/api/intune-mam-managedappoperation-create?view=graph-rest-1.0&tabs=http)|
...
|Beta||[POST /deviceAppManagement/mobileApps/{mobileAppId}/deviceStatuses/{mobileAppInstallStatusId}/app/assign](https://docs.microsoft.com/graph/api/intune-shared-mobileapp-assign?view=graph-rest-beta&tabs=http)|
...
|V1|A,D|[POST /deviceAppManagement/wdacSupplementalPolicies](https://docs.microsoft.com/graph/api/intune-unlock-windowsdefenderapplicationcontrolsupplementalpolicy-create?view=graph-rest-1.0&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/intuneBrandingProfiles/{intuneBrandingProfileId}/assign](https://docs.microsoft.com/graph/api/intune-wip-intunebrandingprofile-assign?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/intuneBrandingProfiles/{intuneBrandingProfileId}/assignments](https://docs.microsoft.com/graph/api/intune-wip-intunebrandingprofileassignment-create?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /deviceManagement/reports/cachedReportConfigurations](https://docs.microsoft.com/graph/api/intune-reporting-devicemanagementcachedreportconfiguration-create?view=graph-rest-beta&tabs=http)|
|V1|A,D|[POST /deviceManagement/reports/exportJobs](https://docs.microsoft.com/graph/api/intune-reporting-devicemanagementexportjob-create?view=graph-rest-1.0&tabs=http)|
...
|Beta|A,D|[POST /deviceManagement/reports/reportSchedules](https://docs.microsoft.com/graph/api/intune-reporting-devicemanagementreportschedule-create?view=graph-rest-beta&tabs=http)|
|V1|A,D|[POST /deviceManagement/windowsInformationProtectionAppLearningSummaries](https://docs.microsoft.com/graph/api/intune-wip-windowsinformationprotectionapplearningsummary-create?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /deviceManagement/windowsInformationProtectionNetworkLearningSummaries](https://docs.microsoft.com/graph/api/intune-wip-windowsinformationprotectionnetworklearningsummary-create?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /users](https://docs.microsoft.com/graph/api/intune-mam-user-create?view=graph-rest-1.0&tabs=http)|
|Beta|A,D|[POST /users/{usersId}/unblockManagedApps](https://docs.microsoft.com/graph/api/intune-mam-user-unblockmanagedapps?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /users/{usersId}/wipeAndBlockManagedApps](https://docs.microsoft.com/graph/api/intune-mam-user-wipeandblockmanagedapps?view=graph-rest-beta&tabs=http)|
|Beta|A,D|[POST /users/{usersId}/wipeManagedAppRegistrationByDeviceTag](https://docs.microsoft.com/graph/api/intune-mam-user-wipemanagedappregistrationbydevicetag?view=graph-rest-beta&tabs=http)|
|V1|A,D|[POST /users/{usersId}/wipeManagedAppRegistrationsByDeviceTag](https://docs.microsoft.com/graph/api/intune-mam-user-wipemanagedappregistrationsbydevicetag?view=graph-rest-1.0&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|7b3f05d5-f68c-4b8d-8c59-a2ecd12f24af|
|**Consent Type**|Admin|
|**Display String**|Read and write Microsoft Intune apps|
...
|profileApplicability|androidProfileApplicability|Android Enterprise profile applicability (AndroidWorkProfile, DeviceOwner, or default (applies to both)). Possible values are: `default`, `androidWorkProfile`, `androidDeviceOwner`.|
|connectedAppsEnabled|Boolean|Setting to specify whether to allow ConnectedApps experience for this app.|
### [androidManagedStoreAppTrack ](https://docs.microsoft.com/graph/api/resources/intune-apps-androidmanagedstoreapptrack?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [androidMinimumOperatingSystem ](https://docs.microsoft.com/graph/api/resources/intune-apps-androidminimumoperatingsystem?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [androidPermissionAction ](https://docs.microsoft.com/graph/api/resources/intune-apps-androidpermissionaction?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-apps-androidprofileapplicability](https://docs.microsoft.com/graph/api/resources/intune-apps-androidprofileapplicability?view=graph-rest-1.0&tabs=http)
...
|minimumSupportedOperatingSystem|androidMinimumOperatingSystem|The value for the minimum applicable operating system.|
### [intune-apps-androidtargetedplatforms](https://docs.microsoft.com/graph/api/resources/intune-apps-androidtargetedplatforms?view=graph-rest-1.0&tabs=http)

### [appConfigurationSettingItem ](https://docs.microsoft.com/graph/api/resources/intune-apps-appconfigurationsettingitem?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-apps-certificatestatus](https://docs.microsoft.com/graph/api/resources/intune-apps-certificatestatus?view=graph-rest-1.0&tabs=http)
...
### [excludedApps ](https://docs.microsoft.com/graph/api/resources/intune-apps-excludedapps?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [fileEncryptionInfo ](https://docs.microsoft.com/graph/api/resources/intune-apps-fileencryptioninfo?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [iosDeviceType ](https://docs.microsoft.com/graph/api/resources/intune-apps-iosdevicetype?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [iosMinimumOperatingSystem ](https://docs.microsoft.com/graph/api/resources/intune-apps-iosminimumoperatingsystem?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|v8_0|Boolean|When TRUE, only Version 8.0 or later is supported. Default value is FALSE. Exactly one of the minimum operating system boolean values will be TRUE.|
|v9_0|Boolean|When TRUE, only Version 9.0 or later is supported. Default value is FALSE. Exactly one of the minimum operating system boolean values will be TRUE.|
...
|userName|String|The user name. Inherited from iosVppAppAssignedLicense|
|userPrincipalName|String|The user principal name. Inherited from iosVppAppAssignedLicense|
### [iosVppAppRevokeLicensesActionResult ](https://docs.microsoft.com/graph/api/resources/intune-apps-iosvppapprevokelicensesactionresult?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [macOSAppScript ](https://docs.microsoft.com/graph/api/resources/intune-apps-macosappscript?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [macOSIncludedApp ](https://docs.microsoft.com/graph/api/resources/intune-apps-macosincludedapp?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [macOSLobChildApp ](https://docs.microsoft.com/graph/api/resources/intune-apps-macoslobchildapp?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [macOSMinimumOperatingSystem ](https://docs.microsoft.com/graph/api/resources/intune-apps-macosminimumoperatingsystem?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
|userName|String|The user name.|
|userPrincipalName|String|The user principal name.|
### [macOsVppAppRevokeLicensesActionResult ](https://docs.microsoft.com/graph/api/resources/intune-apps-macosvppapprevokelicensesactionresult?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|userId|String|UserId associated with the action.|
|managedDeviceId|String|DeviceId associated with the action.|
...
### [intune-apps-managedappavailability](https://docs.microsoft.com/graph/api/resources/intune-apps-managedappavailability?view=graph-rest-1.0&tabs=http)
...
### [intune-apps-microsoftedgechannel](https://docs.microsoft.com/graph/api/resources/intune-apps-microsoftedgechannel?view=graph-rest-1.0&tabs=http)
...
### [intune-apps-microsoftstoreforbusinesslicensetype](https://docs.microsoft.com/graph/api/resources/intune-apps-microsoftstoreforbusinesslicensetype?view=graph-rest-1.0&tabs=http)
...
### [mobileAppAssignmentSettings ](https://docs.microsoft.com/graph/api/resources/intune-apps-mobileappassignmentsettings?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-apps-mobileappcontentfileuploadstate](https://docs.microsoft.com/graph/api/resources/intune-apps-mobileappcontentfileuploadstate?view=graph-rest-1.0&tabs=http)
...
### [intune-apps-mobileappdependencytype](https://docs.microsoft.com/graph/api/resources/intune-apps-mobileappdependencytype?view=graph-rest-1.0&tabs=http)
...
### [intune-apps-mobileapppublishingstate](https://docs.microsoft.com/graph/api/resources/intune-apps-mobileapppublishingstate?view=graph-rest-1.0&tabs=http)
...
### [intune-apps-mobileapprelationshiptype](https://docs.microsoft.com/graph/api/resources/intune-apps-mobileapprelationshiptype?view=graph-rest-1.0&tabs=http)
...
### [intune-apps-mobileappsupersedencetype](https://docs.microsoft.com/graph/api/resources/intune-apps-mobileappsupersedencetype?view=graph-rest-1.0&tabs=http)
...
|fileName|String|The name of the main Lob application file.|
|size|Int64|The total size, including all uploaded files.|
### [intune-apps-officeproductid](https://docs.microsoft.com/graph/api/resources/intune-apps-officeproductid?view=graph-rest-1.0&tabs=http)
...
### [intune-apps-officesuitedefaultfileformattype](https://docs.microsoft.com/graph/api/resources/intune-apps-officesuitedefaultfileformattype?view=graph-rest-1.0&tabs=http)

### [intune-apps-officesuiteinstallprogressdisplaylevel](https://docs.microsoft.com/graph/api/resources/intune-apps-officesuiteinstallprogressdisplaylevel?view=graph-rest-1.0&tabs=http)

### [intune-apps-officeupdatechannel](https://docs.microsoft.com/graph/api/resources/intune-apps-officeupdatechannel?view=graph-rest-1.0&tabs=http)

### [intune-apps-resultantappstatedetail](https://docs.microsoft.com/graph/api/resources/intune-apps-resultantappstatedetail?view=graph-rest-1.0&tabs=http)
...
### [vppLicensingType ](https://docs.microsoft.com/graph/api/resources/intune-apps-vpplicensingtype?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [win32LobAppDetection ](https://docs.microsoft.com/graph/api/resources/intune-apps-win32lobappdetection?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
### [win32LobAppInstallExperience ](https://docs.microsoft.com/graph/api/resources/intune-apps-win32lobappinstallexperience?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [win32LobAppMsiInformation ](https://docs.microsoft.com/graph/api/resources/intune-apps-win32lobappmsiinformation?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [win32LobAppRequirement ](https://docs.microsoft.com/graph/api/resources/intune-apps-win32lobapprequirement?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [win32LobAppReturnCode ](https://docs.microsoft.com/graph/api/resources/intune-apps-win32lobappreturncode?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [win32LobAppRule ](https://docs.microsoft.com/graph/api/resources/intune-apps-win32lobapprule?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-apps-windowsarchitecture](https://docs.microsoft.com/graph/api/resources/intune-apps-windowsarchitecture?view=graph-rest-1.0&tabs=http)

### [intune-apps-windowsdevicetype](https://docs.microsoft.com/graph/api/resources/intune-apps-windowsdevicetype?view=graph-rest-1.0&tabs=http)
...
### [windowsMinimumOperatingSystem ](https://docs.microsoft.com/graph/api/resources/intune-apps-windowsminimumoperatingsystem?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [windowsPackageInformation ](https://docs.microsoft.com/graph/api/resources/intune-apps-windowspackageinformation?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [winGetAppInstallExperience ](https://docs.microsoft.com/graph/api/resources/intune-apps-wingetappinstallexperience?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|runAsAccount|runAsAccountType|Indicates the type of execution context the app setup runs in on target devices. Options include values of the RunAsAccountType enum, which are System and User. Required at creation time, cannot be modified on existing objects. Possible values are: `system`, `user`.|
### [auditActor ](https://docs.microsoft.com/graph/api/resources/intune-auditing-auditactor?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [auditResource ](https://docs.microsoft.com/graph/api/resources/intune-auditing-auditresource?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|displayName|String|Display name.|
|modifiedProperties|auditProperty collection|List of modified properties.|
...
### [intune-books-installstate](https://docs.microsoft.com/graph/api/resources/intune-books-installstate?view=graph-rest-1.0&tabs=http)
...
### [intune-mam-androidmanagedappsafetynetappsverificationtype](https://docs.microsoft.com/graph/api/resources/intune-mam-androidmanagedappsafetynetappsverificationtype?view=graph-rest-1.0&tabs=http)

### [intune-mam-androidmanagedappsafetynetdeviceattestationtype](https://docs.microsoft.com/graph/api/resources/intune-mam-androidmanagedappsafetynetdeviceattestationtype?view=graph-rest-1.0&tabs=http)

### [intune-mam-androidmanagedappsafetynetevaluationtype](https://docs.microsoft.com/graph/api/resources/intune-mam-androidmanagedappsafetynetevaluationtype?view=graph-rest-1.0&tabs=http)

### [intune-mam-appmanagementlevel](https://docs.microsoft.com/graph/api/resources/intune-mam-appmanagementlevel?view=graph-rest-1.0&tabs=http)
...
|id|String|Key of the entity. Inherited from managedAppRegistration|
|version|String|Version of the entity. Inherited from managedAppRegistration|
### [intune-mam-managedappclipboardsharinglevel](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappclipboardsharinglevel?view=graph-rest-1.0&tabs=http)
...
### [intune-mam-managedappdataencryptiontype](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappdataencryptiontype?view=graph-rest-1.0&tabs=http)

### [intune-mam-managedappdataingestionlocation](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappdataingestionlocation?view=graph-rest-1.0&tabs=http)

### [intune-mam-managedappdatastoragelocation](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappdatastoragelocation?view=graph-rest-1.0&tabs=http)

### [intune-mam-managedappdatatransferlevel](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappdatatransferlevel?view=graph-rest-1.0&tabs=http)

### [intune-mam-managedappdevicethreatlevel](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappdevicethreatlevel?view=graph-rest-1.0&tabs=http)
...
### [intune-mam-managedappflaggedreason](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappflaggedreason?view=graph-rest-1.0&tabs=http)
...
### [managedAppLogUpload ](https://docs.microsoft.com/graph/api/resources/intune-mam-managedapplogupload?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
|status|managedAppLogUploadState|The status of the log upload. If a result is present, the log collection is complete and the upload status for the component is final. completed is the default value. Read-only. Possible values are: `pending`, `inProgress`, `completed`, `declinedByUser`, `timedOut`, `failed`, `unknownFutureValue`.|
|referenceId|String|A provider-specific reference id for the uploaded logs. Read-only.|
### [intune-mam-managedapploguploadconsent](https://docs.microsoft.com/graph/api/resources/intune-mam-managedapploguploadconsent?view=graph-rest-1.0&tabs=http)

### [intune-mam-managedappnotificationrestriction](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappnotificationrestriction?view=graph-rest-1.0&tabs=http)
...
|id|String|Key of the entity.|
|version|String|Version of the entity.|
### [intune-mam-managedappphonenumberredirectlevel](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappphonenumberredirectlevel?view=graph-rest-1.0&tabs=http)

### [intune-mam-managedapppincharacterset](https://docs.microsoft.com/graph/api/resources/intune-mam-managedapppincharacterset?view=graph-rest-1.0&tabs=http)
...
|id|String|Key of the entity.|
|version|String|Version of the entity.|
### [managedAppPolicyDeploymentSummaryPerApp ](https://docs.microsoft.com/graph/api/resources/intune-mam-managedapppolicydeploymentsummaryperapp?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
|id|String|Key of the entity.|
|version|String|Version of the entity.|
### [intune-mam-managedappremediationaction](https://docs.microsoft.com/graph/api/resources/intune-mam-managedappremediationaction?view=graph-rest-1.0&tabs=http)
...
### [intune-mam-managedbrowsertype](https://docs.microsoft.com/graph/api/resources/intune-mam-managedbrowsertype?view=graph-rest-1.0&tabs=http)
...
### [intune-mam-messagingredirectapptype](https://docs.microsoft.com/graph/api/resources/intune-mam-messagingredirectapptype?view=graph-rest-1.0&tabs=http)

### [mobileAppIdentifier ](https://docs.microsoft.com/graph/api/resources/intune-mam-mobileappidentifier?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
### [intune-mam-mobilethreatdefensepartnerpriority](https://docs.microsoft.com/graph/api/resources/intune-mam-mobilethreatdefensepartnerpriority?view=graph-rest-1.0&tabs=http)
...
### [intune-mam-targetedmanagedappgrouptype](https://docs.microsoft.com/graph/api/resources/intune-mam-targetedmanagedappgrouptype?view=graph-rest-1.0&tabs=http)
...
|isAssigned|Boolean|Indicates if the policy is deployed to any inclusion groups or not.|
### [windowsInformationProtectionApp ](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsinformationprotectionapp?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
|id|String|Key of the entity.|
|version|String|Version of the entity.|
### [windowsInformationProtectionDataRecoveryCertificate ](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsinformationprotectiondatarecoverycertificate?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-mam-windowsinformationprotectionenforcementlevel](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsinformationprotectionenforcementlevel?view=graph-rest-1.0&tabs=http)

### [windowsInformationProtectionIPRangeCollection ](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsinformationprotectioniprangecollection?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|displayName|String|Display name|
|ranges|ipRange collection|Collection of ip ranges|
### [intune-mam-windowsinformationprotectionpincharacterrequirements](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsinformationprotectionpincharacterrequirements?view=graph-rest-1.0&tabs=http)
...
### [windowsInformationProtectionProxiedDomainCollection ](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsinformationprotectionproxieddomaincollection?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|displayName|String|Display name|
|proxiedDomains|proxiedDomain collection|Collection of proxied domains|
### [windowsInformationProtectionResourceCollection ](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsinformationprotectionresourcecollection?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|displayName|String|Display name|
...
### [intune-mam-windowsmanagedappclipboardsharinglevel](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsmanagedappclipboardsharinglevel?view=graph-rest-1.0&tabs=http)

### [intune-mam-windowsmanagedappdatatransferlevel](https://docs.microsoft.com/graph/api/resources/intune-mam-windowsmanagedappdatatransferlevel?view=graph-rest-1.0&tabs=http)
...
### [intune-onboarding-microsoftstoreforbusinessportalselectionoptions](https://docs.microsoft.com/graph/api/resources/intune-onboarding-microsoftstoreforbusinessportalselectionoptions?view=graph-rest-1.0&tabs=http)
...
### [intune-partnerintegration-appvulnerabilitytaskmitigationtype](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-appvulnerabilitytaskmitigationtype?view=graph-rest-1.0&tabs=http)
...
### [intune-partnerintegration-deviceappmanagementtaskcategory](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-deviceappmanagementtaskcategory?view=graph-rest-1.0&tabs=http)

### [intune-partnerintegration-deviceappmanagementtaskpriority](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-deviceappmanagementtaskpriority?view=graph-rest-1.0&tabs=http)

### [intune-partnerintegration-deviceappmanagementtaskstatus](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-deviceappmanagementtaskstatus?view=graph-rest-1.0&tabs=http)

### [intune-partnerintegration-endpointsecurityconfigurationapplicableplatform](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-endpointsecurityconfigurationapplicableplatform?view=graph-rest-1.0&tabs=http)

### [intune-partnerintegration-endpointsecurityconfigurationprofiletype](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-endpointsecurityconfigurationprofiletype?view=graph-rest-1.0&tabs=http)

### [intune-partnerintegration-endpointsecurityconfigurationtype](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-endpointsecurityconfigurationtype?view=graph-rest-1.0&tabs=http)
...
### [unmanagedDevice ](https://docs.microsoft.com/graph/api/resources/intune-partnerintegration-unmanageddevice?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-reporting-devicemanagementexportjoblocalizationtype](https://docs.microsoft.com/graph/api/resources/intune-reporting-devicemanagementexportjoblocalizationtype?view=graph-rest-1.0&tabs=http)

### [intune-reporting-devicemanagementreportfileformat](https://docs.microsoft.com/graph/api/resources/intune-reporting-devicemanagementreportfileformat?view=graph-rest-1.0&tabs=http)
...
### [intune-reporting-devicemanagementreportstatus](https://docs.microsoft.com/graph/api/resources/intune-reporting-devicemanagementreportstatus?view=graph-rest-1.0&tabs=http)

### [intune-reporting-devicemanagementscheduledreportrecurrence](https://docs.microsoft.com/graph/api/resources/intune-reporting-devicemanagementscheduledreportrecurrence?view=graph-rest-1.0&tabs=http)

### [intune-shared-actionstate](https://docs.microsoft.com/graph/api/resources/intune-shared-actionstate?view=graph-rest-1.0&tabs=http)
...
### [companyPortalBlockedAction ](https://docs.microsoft.com/graph/api/resources/intune-shared-companyportalblockedaction?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-shared-compliancestatus](https://docs.microsoft.com/graph/api/resources/intune-shared-compliancestatus?view=graph-rest-1.0&tabs=http)
...
### [intune-shared-devicemanagementconfigurationcontroltype](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationcontroltype?view=graph-rest-1.0&tabs=http)

### [deviceManagementConfigurationDependentOn ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationdependenton?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [deviceManagementConfigurationOptionDefinition ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationoptiondefinition?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|optionValue|deviceManagementConfigurationSettingValue|Value of the option|
|dependentOn|deviceManagementConfigurationDependentOn collection|List of dependent settings for this option|
|dependedOnBy|deviceManagementConfigurationSettingDependedOnBy collection|List of Settings that depends on this option|
...
### [deviceManagementConfigurationReferredSettingInformation ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationreferredsettinginformation?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|settingDefinitionId|String|Setting definition id that is being referred to a setting. Applicable for reusable setting|
### [intune-shared-devicemanagementconfigurationsettingaccesstypes](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingaccesstypes?view=graph-rest-1.0&tabs=http)

### [deviceManagementConfigurationSettingApplicability ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingapplicability?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|description|String|description of the setting|
|platform|deviceManagementConfigurationPlatforms|Platform setting can be applied on. Possible values are: `none`, `android`, `iOS`, `macOS`, `windows10X`, `windows10`, `linux`, `unknownFutureValue`.|
...
|technologies|deviceManagementConfigurationTechnologies|Which technology channels this setting can be deployed through. Possible values are: `none`, `mdm`, `windows10XManagement`, `configManager`, `appleRemoteManagement`, `microsoftSense`, `exchangeOnline`, `linuxMdm`, `enrollment`, `endpointPrivilegeManagement`, `unknownFutureValue`.|
...
### [deviceManagementConfigurationSettingDependedOnBy ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingdependedonby?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [deviceManagementConfigurationSettingOccurrence ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingoccurrence?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [intune-shared-devicemanagementconfigurationsettingusage](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingusage?view=graph-rest-1.0&tabs=http)

### [deviceManagementConfigurationSettingValue ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingvalue?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|settingValueTemplateReference|deviceManagementConfigurationSettingValueTemplateReference|Setting value template reference|
### [deviceManagementConfigurationSettingValueDefinition ](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingvaluedefinition?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
### [intune-shared-devicemanagementconfigurationsettingvisibility](https://docs.microsoft.com/graph/api/resources/intune-shared-devicemanagementconfigurationsettingvisibility?view=graph-rest-1.0&tabs=http)
...
|dependedOnBy|deviceManagementConfigurationSettingDependedOnBy collection|list of child settings that depend on this setting|
### [intune-shared-enrollmentavailabilityoptions](https://docs.microsoft.com/graph/api/resources/intune-shared-enrollmentavailabilityoptions?view=graph-rest-1.0&tabs=http)

### [intune-shared-installintent](https://docs.microsoft.com/graph/api/resources/intune-shared-installintent?view=graph-rest-1.0&tabs=http)
...
### [keyValuePair ](https://docs.microsoft.com/graph/api/resources/intune-shared-keyvaluepair?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
|smbAutoEncryptedFileExtensions|windowsInformationProtectionResourceCollection collection|Specifies a list of file extensions, so that files with these extensions are encrypted when copying from an SMB share within the corporate boundary Inherited from windowsInformationProtection|
|isAssigned|Boolean|Indicates if the policy is deployed to any inclusion groups or not. Inherited from windowsInformationProtection|
### [mimeContent ](https://docs.microsoft.com/graph/api/resources/intune-shared-mimecontent?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
...
### [mobileAppAssignmentSettings ](https://docs.microsoft.com/graph/api/resources/intune-shared-mobileappassignmentsettings?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
### [intune-shared-resultantappstate](https://docs.microsoft.com/graph/api/resources/intune-shared-resultantappstate?view=graph-rest-1.0&tabs=http)

### [rgbColor ](https://docs.microsoft.com/graph/api/resources/intune-shared-rgbcolor?view=graph-rest-1.0&tabs=http)
|Property|Type|Description|
|:---|:---|:---|
|r|Byte|Red value|
|g|Byte|Green value|
...
### [intune-unlock-windowsdefenderapplicationcontrolsupplementalpolicystatuses](https://docs.microsoft.com/graph/api/resources/intune-unlock-windowsdefenderapplicationcontrolsupplementalpolicystatuses?view=graph-rest-1.0&tabs=http)

### [intune-wip-applicationtype](https://docs.microsoft.com/graph/api/resources/intune-wip-applicationtype?view=graph-rest-1.0&tabs=http)
