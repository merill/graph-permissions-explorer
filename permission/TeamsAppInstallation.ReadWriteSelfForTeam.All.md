...
|Ver|Type|Method|
|-------|----|------|
|V1|A|[DELETE /teams/{team-id}/installedApps/{app-installation-id}](https://docs.microsoft.com/graph/api/team-delete-installedapps?view=graph-rest-1.0&tabs=http)|
...
|V1|A|[POST /teams/{team-id}/installedApps](https://docs.microsoft.com/graph/api/team-post-installedapps?view=graph-rest-1.0&tabs=http)|
...
|**Display String**|Allow the Teams app to manage itself for all teams|
