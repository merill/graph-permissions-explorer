...
|V1|A,D|[PATCH /security/incidents/{incidentId}](https://docs.microsoft.com/graph/api/security-incident-update?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[POST /security/incidents/{incidentId}/comments](https://docs.microsoft.com/graph/api/security-incident-post-comments?view=graph-rest-1.0&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|128ca929-1a19-45e6-a3b8-435ec44a36ba|
|**Consent Type**|Admin|
|**Display String**|Read and write to incidents|
...
|**Display String**|Read and write to all security incidents|
