...
|Ver|Type|Method|
|-------|----|------|
|V1|A|[DELETE /chats/{chat-id}/pinnedMessages/{pinnedChatMessageId}](https://docs.microsoft.com/graph/api/chat-delete-pinnedmessages?view=graph-rest-1.0&tabs=http)|
...
|V1|A|[GET /users/{id | user-principal-name}/chats/getAllMessages](https://docs.microsoft.com/graph/api/chats-getallmessages?view=graph-rest-1.0&tabs=http)|
|Beta|A|[GET /users/{id}/chats/getAllRetainedMessages](https://docs.microsoft.com/graph/api/chat-getallretainedmessages?view=graph-rest-beta&tabs=http)|
...
|V1|A|[PATCH /chats/{chat-id}](https://docs.microsoft.com/graph/api/chat-patch?view=graph-rest-1.0&tabs=http)|
...
|V1|A|[POST /chats/{chat-Id}/pinnedMessages](https://docs.microsoft.com/graph/api/chat-post-pinnedmessages?view=graph-rest-1.0&tabs=http)|
|Beta|D|[POST /chats/{chatsId}/removeAllAccessForUser](https://docs.microsoft.com/graph/api/chat-removeallaccessforuser?view=graph-rest-beta&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|7e9a077b-3711-42b9-b7cb-5fa5f3f7fea7|
|**Consent Type**|Admin|
|**Display String**|Read and write all chat messages|
