...
|V1|A,D|[DELETE /teams/{team-id}/incomingChannels/{incoming-channel-id}/$ref](https://docs.microsoft.com/graph/api/team-delete-incomingchannels?view=graph-rest-1.0&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|cc83893a-e232-4723-b5af-bd0b01bcfe65|
|**Consent Type**|Admin|
|**Display String**|Delete channels|
