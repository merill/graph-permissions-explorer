...
|V1|A,D|[GET /chats/{chat-id}/tabs](https://docs.microsoft.com/graph/api/chat-list-tabs?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[GET /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-get-tabs?view=graph-rest-1.0&tabs=http)|
