...
|Beta|A,D|[GET /print/printers/{id}/jobs/{id}/documents/{id}/$value](https://docs.microsoft.com/graph/api/printdocument-get-file?view=graph-rest-beta&tabs=http)|
...
|V1|A,D|[GET /print/printers/{printerId}/jobs/{printJobId}/documents/{printDocumentId}/$value](https://docs.microsoft.com/graph/api/printdocument-get-file?view=graph-rest-1.0&tabs=http)|
...
|V1|A,D|[POST /print/printers/{id}/jobs/{id}/documents/{id}/createUploadSession](https://docs.microsoft.com/graph/api/printdocument-createuploadsession?view=graph-rest-1.0&tabs=http)|
