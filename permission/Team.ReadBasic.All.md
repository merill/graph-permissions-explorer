...
|V1|A,D|[GET /teamwork/deletedTeams](https://docs.microsoft.com/graph/api/teamwork-list-deletedteams?view=graph-rest-1.0&tabs=http)|
...
|**Consent Type**|User|
|**Display String**|Read the names and descriptions of teams|
...
|**Display String**|Get a list of all teams|
