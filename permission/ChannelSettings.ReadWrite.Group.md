...
|Ver|Type|Method|
|-------|----|------|
|V1|A|[GET /teams/{id}/primaryChannel](https://docs.microsoft.com/graph/api/team-get-primarychannel?view=graph-rest-1.0&tabs=http)|
|V1|A|[GET /teams/{team-id}/channels](https://docs.microsoft.com/graph/api/channel-list?view=graph-rest-1.0&tabs=http)|
|V1|A|[GET /teams/{team-id}/channels/{channel-id}](https://docs.microsoft.com/graph/api/channel-get?view=graph-rest-1.0&tabs=http)|
|V1|A|[PATCH /teams/{team-id}/channels/{channel-id}](https://docs.microsoft.com/graph/api/channel-patch?view=graph-rest-1.0&tabs=http)|
