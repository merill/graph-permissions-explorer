...
|Ver|Type|Method|
|-------|----|------|
|V1|D|[DELETE /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-delete-tabs?view=graph-rest-1.0&tabs=http)|
|V1|D|[GET /chats/{chat-id}/tabs](https://docs.microsoft.com/graph/api/chat-list-tabs?view=graph-rest-1.0&tabs=http)|
|V1|D|[GET /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-get-tabs?view=graph-rest-1.0&tabs=http)|
|V1|D|[PATCH /chats/{chat-id}/tabs/{tab-id}](https://docs.microsoft.com/graph/api/chat-patch-tabs?view=graph-rest-1.0&tabs=http)|
|V1|D|[POST /chats/{chat-id}/tabs](https://docs.microsoft.com/graph/api/chat-post-tabs?view=graph-rest-1.0&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**|0c219d04-3abf-47f7-912d-5cca239e90e6|
|**Consent Type**|Admin|
|**Display String**|Allow the Teams app to manage only its own tabs in chats|
