...
|Ver|Type|Method|
|-------|----|------|
|V1|A,D|[GET /chats/{id}/members/{id}](https://docs.microsoft.com/graph/api/conversationmember-get?view=graph-rest-1.0&tabs=http)|
|V1|A,D|[GET /teams/{id}/channels/{id}/members/{id}](https://docs.microsoft.com/graph/api/conversationmember-get?view=graph-rest-1.0&tabs=http)|
## Delegate Permission
|||
|-|-|
|**Id**||
